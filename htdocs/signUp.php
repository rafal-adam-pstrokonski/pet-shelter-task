<?php
$registerApiUrl = "https://x8ki-letl-twmt.n7.xano.io/api:gTVuShjQ/auth/signup";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$email) {
        ...
        if (in_array($status_code, [200, 201, 202])) {
            echo "<p class='pet' style='color:green;'>Registration successful! Please check your email for confirmation.</p>";
        } else {
            echo "<p class='pet' style='color:red;'>Registration failed."; 
...
<!-- ######################## -->
    ...
    <title>Schronisko P&R Rejestracja</title>
</head>
<body>
